/*
 * Dragoon Microkernel - 8x16 Bitmap Font
 *
 * Standard VGA-style font for ASCII 32-126.
 * Each character is 8 pixels wide, 16 pixels tall.
 * Stored as 16 bytes per glyph, MSB = leftmost pixel.
 */
#include "font.h"
...
{
    if (c < 32 || c > 126)
        return font_data[0]; /* return space for out-of-range */
